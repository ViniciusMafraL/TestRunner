...
function seedSportiaProjects() {
  return {
    Sportia: makeProject([
      ...
      { id: 'BUG-004', status: 'Fixed', severity: 'Low', tag: 'Hub', title: 'Ícone do Hub com cor errada', description: '', attachment: '', foundBy: 'Miguel', version: '1.4.0', platform: 'Pc', keywords: 'Design', store: 'Gameloft', createdIn: '2026-04-10' },
      ...
      { id: 'BUG-008', status: 'Reopen', severity: 'Normal', tag: 'Menu', title: 'Issue reaberta com versão malformada', description: 'Dado "sujo" propositalmente: valida que a Home não quebra com versão fora do padrão 0.0.0 e que "Reopen" é exibida dentro da seção "Open" do Issue Tracker.', attachment: '', foundBy: 'Karen', version: 'v-next', platform: 'Web', keywords: 'Bug', store: 'Steam', createdIn: '2026-06-15' },
    ]),
  };
}
