...
import { SectionRoute } from './auth/SectionRoute.jsx';
    ...
    <SessionProvider>
      <Routes>
        ...
        >
          ...
          {/* Telas restritas: papéis sem navegação completa (developer/viewer/
              convidado) são redirecionados a /home mesmo por URL direta. */}
          <Route
            path="/reporter"
            element={
              <SectionRoute basePath="/reporter">
                <Reporter />
              </SectionRoute>
            }
          />
          <Route
            path="/test-run"
            element={
              <SectionRoute basePath="/test-run">
                <TestRun />
              </SectionRoute>
            }
          />
          <Route
            path="/test-plan"
            element={
              <SectionRoute basePath="/test-plan">
                <TestPlan />
              </SectionRoute>
            }
          />
